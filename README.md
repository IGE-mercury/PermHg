...
## Contents
- `sediment_hg_dataset_v1.csv` — Data file containing lake sediment Hg observations  
- `soil_hg_dataset_v1.csv` — Data file containing lake soil Hg observations 
- `vegetation_hg_dataset_v1.csv` — Data file containing vegetation Hg observations 
- `water_hg_dataset_v1.csv` — Data file containing aqueous Hg observations 
